...
public class RobotController : MonoBehaviour
{
    ...
    //Sets the character to still upon entry (no movement)
    ...
    void FixedUpdate()
    {
        ...
        //TDT_200: Line 42 checks what value is held in the 'grounded' variable, either T or F
    ...
    private void Update()
    {
        //If Robot is on the ground and the space bar was pressed, 
        //change our ground state and add an upward force
